<nav class="navbar navbar-expand-lg navbar-dark background-nav">
	<a class="navbar-brand" href="index.jsp"><span class="fa fa-area-chart">
	</span>&nbsp; Soft Blog</a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item active"><a class="nav-link" href="index.jsp"><span
					class="fa fa-institution"> </span>&nbsp; Home <span class="sr-only">(current)</span>
			</a></li>
		...
		<form class="form-inline my-2 my-lg-0">
			...
			<button class="btn btn-outline-primary my-2 my-sm-0 text-white"
